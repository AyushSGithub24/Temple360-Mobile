...
public class PanoActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        viewBinder.button_like.setOnClickListener(v -> {
            if(currentImageItem != null) {
                if(currentImageItem.isInBelongGalleries(ListDataService.GALLERY_LIST_ID_I_LIKE)) {
                    ...
                    ToastUtils.show(PanoActivity.this,getString(R.string.text_removed_from_i_like));
                }
                else {
                    currentImageItem.belongGalleries.add(ListDataService.GALLERY_LIST_ID_I_LIKE);
                    ToastUtils.show(PanoActivity.this,getString(R.string.text_added_to_i_like));
                }
        ...
        findViewById(R.id.layout_info_path).setOnClickListener((v) -> {
            ...
            ToastUtils.show(PanoActivity.this,getString(R.string.text_path_copied_to_clipboard));
        });
            ...
            .setOnResult((b, dialog) -> {
                if(b == CommonDialog.BUTTON_POSITIVE) {
                    if(FileUtils.deleteFile(filePath)) {
                        ToastUtils.show(PanoActivity.this,getString(R.string.text_delete_success));
                        ...
                        ToastUtils.show(PanoActivity.this,getString(R.string.text_delete_failed));
                    return true;
    ...
    private void screenShotCallback(Bitmap b) {
        ...
        runOnUiThread(() -> {
            ...
            if(result.success)
                ToastUtils.show(PanoActivity.this,getString(R.string.text_image_save_success));
            else
                ToastUtils.show(PanoActivity.this,String.format(getString(R.string.text_image_save_failed), result.error));
        });
        ...
        new Thread(() -> {
            ...
            try {
                ...
                try {
                    ...
                    android.util.Log.w(TAG, "MediaMetadataRetriever.release() failed: " + e.toString());
                }
            }
    ...
    private void nextFile() {
        ...
        if(currentIndex >= fileList.size() - 1) {
            ToastUtils.show(PanoActivity.this,getString(R.string.text_this_is_last_image));
        } else {
    ...
    private void prevFile() {
        ...
        int currentIndex = findIndexInPathList(filePath);
        if(currentIndex <= 0) {
            ToastUtils.show(PanoActivity.this,getString(R.string.text_this_is_first_image));
            return;
        }
        loadFile(fileList.get(currentIndex - 1).toString(), false);
    }
