...
public class GalleryActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId() == R.id.action_import_pano) {
            ...
            ToastUtils.show(GalleryActivity.this,getString(R.string.text_select_items_showed_in_main));
        }
        else if(item.getItemId() == R.id.action_hide_in_main) {
            listDataService.setGalleryListItemShowInMain(currentGalleryId, false);
            listDataService.setDataDirty(true);
            ToastUtils.show(GalleryActivity.this,getString(R.string.text_select_items_hidden_in_main));
        }
    ...
    private void initGallery() {
        if(currentGalleryId == 0) {
            ToastUtils.show(GalleryActivity.this,"Bad galleryId");
            finish();
            return;
        }
    ...
    private void importFiles(ArrayList<Photo> photos) {
        ...
        ToastUtils.show(GalleryActivity.this,String.format(getString(R.string.text_import_success_count), addCount));
    }
        ...
        if(sel.size() > 0) {
            ...
            chooseGalleryDialogFragment.setOnChooseGalleryListener((galleryId) -> {
                ...
                chooseItemDialogFragment.setOnChooseItemListener((choose, i, c) -> {
                    ...
                    ToastUtils.show(GalleryActivity.this,R.string.text_add_success);
                });
                    ...
                    .setOnChooseItemListener((choosed, index, item) -> {
                        if(choosed) {
                            if(index == 0 || index == 1) {
                                ...
                                ToastUtils.show(GalleryActivity.this,getString(index == 0 ?
