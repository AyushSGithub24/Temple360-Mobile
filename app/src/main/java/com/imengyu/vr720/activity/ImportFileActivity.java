    ...
    private void doImport() {
        if(Intent.ACTION_SEND.equals(intent.getAction())) {
            ...
            if(uri != null) {
                ...
                arr[0] = uri;
                goImport(arr);
            } else ToastUtils.show(ImportFileActivity.this,"Intent.EXTRA_STREAM not set");
            ...
            if(clipData != null && clipData.getItemCount() > 0) {
                ...
                goImport(arr);
            } else ToastUtils.show(ImportFileActivity.this,"No file was provided");
        } else ToastUtils.show(ImportFileActivity.this,"Bad Action");
        finish();
    }
