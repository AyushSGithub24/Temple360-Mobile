...
public class CommonSettingsFragment extends PreferenceFragmentCompat {
    private void downloadApk(String url) {
        ...
        request.setDestinationInExternalPublicDir(
                Environment.DIRECTORY_DOWNLOADS, "vr720-update.apk");

        android.app.DownloadManager dm =
                (android.app.DownloadManager) requireActivity().getSystemService(Context.DOWNLOAD_SERVICE);

        dm.enqueue(request);

        ToastUtils.show(getContext(), "Downloading update…");
    }
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        app_check_update.setOnPreferenceClickListener(preference -> {
            if (NetworkUtils.isNetworkConnected(activity)) {
                ...
                ToastUtils.show(getContext(),getString(R.string.text_network_not_connect));
            }
            return true;
        });

        app_check_update.setSummary(
                getString(R.string.text_soft_version) + BuildConfig.VERSION_NAME
        );
        ...
        settings_key_clear_cache.setSummary(
                String.format(getString(R.string.text_now_cache_size), cacheServices.getCacheDirSize())
        );
                        ...
                        if (b == CommonDialog.BUTTON_POSITIVE) {
                            ...
                            new Thread(() -> {
                                ...
                                activity.runOnUiThread(() -> {
                                    ...
                                    ToastUtils.show(getContext(),getString(R.string.text_cache_clear_finish));
                                });
                            }).start();
        ...
        native_log_level.setOnPreferenceChangeListener((preference, object) -> {
            sharedPreferences.edit()
                    .putInt("native_log_level", Integer.parseInt(object.toString()))
                    .apply();
            return true;
        });
    }
            ...
            public void onCheckUpdateSuccess(boolean hasUpdate, String newVer, int newVerCode,
                ...
                activity.runOnUiThread(() -> {
                    ...
                    if (hasUpdate) {
                        ...
                        ToastUtils.show(getContext(),getString(R.string.text_update_latest));
                    }
