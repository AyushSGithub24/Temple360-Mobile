...
public class SettingsFragment extends PreferenceFragmentCompat {
            ...
            new CommonDialog(activity)
                    ...
                    .setOnResult((b, dialog) -> {
                        if(b == CommonDialog.BUTTON_POSITIVE) {
                            ...
                            ToastUtils.show(getContext(), R.string.text_all_settings_reset_to_default);
                            return true;
    ...
    private void doExportSettings(String path) {
        ...
        if(FileUtils.writeToTextFile(path, jsonObject.toJSONString()))
            ToastUtils.show(getContext(),R.string.text_settings_backup_to_file);
        else
            ToastUtils.show(getContext(),R.string.text_failed);
    }
                ...
                .setOnResult((b, dialog) -> {
                    if(b == CommonDialog.BUTTON_POSITIVE) {
                        ...
                        try {
                            ...
                            ToastUtils.show(getContext(),getString(R.string.text_settings_import_success));
                        } catch (Exception e) {
                            e.printStackTrace();
                            ToastUtils.show(getContext(),getString(R.string.text_failed) + "\n" + e.toString());
                        }
                        return true;
                    } else return b == CommonDialog.BUTTON_NEGATIVE;
                })
